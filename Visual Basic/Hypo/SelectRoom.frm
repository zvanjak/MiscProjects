...
Private Sub Form_Load()
    ...
    Call SetLabel(labSelectRoom, "SelectRoom")
    Call SetLabel(labFloor, "Floor")
    Call SetLabel(labRoomNumber, "RoomNumber")
    
    Timer1.Interval = TIMER_INT
    Timer1.Enabled = True
    
    Dim s As String
    s = GetLabel("FloorSmall")
    
    cmdSelFloor(0).Caption = "0. " & s
    cmdSelFloor(1).Caption = "1. " & s
    cmdSelFloor(2).Caption = "2. " & s
    cmdSelFloor(3).Caption = "3. " & s
    cmdSelFloor(4).Caption = "4. " & s
